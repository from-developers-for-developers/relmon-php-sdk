...
class JsonStringParserTest extends TestCase
{
    public function testParseFullNotationJsonString(): void
    {
    ...
    public function testParseCompactNotationJsonString(): void
    {
        $parser = new JsonStringParser();
        $input = json_encode([
            'p' => '1.0',
