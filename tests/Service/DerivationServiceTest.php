...
class DerivationServiceTest extends TestCase
{
    public static function deriveDataProvider(): array
    {
        return [
            ...
            [
                new DummyMonetaryBasis(netInMinors: 10000, grossInMinors: 12000, taxRateInMinors: 2100),
                'relmon@1.0.0/1',
                RoundingMode::HALF_EVEN,
                RoundingApplication::TAX,
                2,
            ...
            [
                new DummyMonetaryBasis(netInMinors: -10000, grossInMinors: -12100, taxRateInMinors: 2100),
                'relmon@1.0.0/1',
                RoundingMode::HALF_EVEN,
                RoundingApplication::TOTAL,
                2,
            ...
            [
                new DummyMonetaryBasis(netInMinors: -12100, grossInMinors: -10000, taxInMinors: -2100),
                'relmon@1.0.0/3',
                RoundingMode::HALF_EVEN,
                RoundingApplication::TAX,
                2,
            ...
            [
                ...
                2,
                null,
                new DerivationException('Unsupported determinism level.'),
            ],
        ];
    }
